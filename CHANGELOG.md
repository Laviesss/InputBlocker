...
## [0.1.0] - 2026-05-20
### Added
- Initial release of the Android Engine with surgical touch filtering.
- PC Designer for visual region mapping and threshold tuning.
- DBSCAN-based auto-tuning for ghost tap hotspots.
- Root agnostic support for Magisk, KernelSU, and APatch.
- Emergency reset gesture (top-left corner).
